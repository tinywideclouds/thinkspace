...
<div class="chat-layout">
  ...
  <main class="chat-main">
    <div class="chat-header">
      ...
      <div class="connection-status" [class.connected]="state.connected()">
    ...
    <div class="chat-scroll-area">
      ...
      <llm-chat-feed 
        [feed]="state.coreChat()" 
        (inspectFlow)="state.inspectFlow($event)"
      />
  ...
  <!-- Bottom Drawer: The Factory Floor -->
  <aside class="chat-drawer">
    <llm-flow-tracker [flows]="state.flowStates()"></llm-flow-tracker>
  </aside>

  <!-- Overlay: The X-Ray Inspector -->
  @if (state.inspectedReceipt()) {
    <llm-flow-inspector 
      [receiptXml]="state.inspectedReceipt()!"
      (close)="state.inspectedReceipt.set(null)">
    </llm-flow-inspector>
  }
